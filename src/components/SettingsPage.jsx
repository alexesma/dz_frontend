...
const SettingsPage = () => {
    ...
    const schedulerMeta = {
        ...
        dragonzap_production_waves: {
            title: 'Производственные волны DragonZap',
            description:
                'В выбранные отсечки (МСК) собирает новые подтверждённые строки DragonZap в общую волну. При достаточном остатке партии резервируются автоматически; дефицит остаётся черновиком для проверки.',
        },
    };
        ...
        <>
            <Card title="Настройки проверки прайсов">
                <Paragraph style={{ marginBottom: 16 }}>
                    ...
                    заданы, проверка выполняется каждые 15 минут круглосуточно.
                    В противном случае — только в выбранные дни и время.
                </Paragraph>
                <Form
                    form={form}
                    layout="vertical"
